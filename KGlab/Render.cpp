...
{    
	...
	glBegin(GL_POLYGON);
	glNormal3d(0, 0, 1);
	glTexCoord2d(double(1) / 14 * 7, double(1) / 16 * 11);
	glVertex3dv(point1up);
	glTexCoord2d(double(1)/14, 1);
	glVertex3dv(point8up);
	glTexCoord2d(double(1) / 14 * 5, double(1) / 16 * 9);
	glVertex3dv(point7up);
	glTexCoord2d(double(1) / 14 * 2, double(1) / 16 * 6);
	...
	for (int i = 0; i <= number; i++) {
		double c = cosf(i * 2 * pi / number);
		double s = sinf(i * 2 * pi / number);
		if ((radius * c + (-3)) <= -2 && radius * s + (-5.5) <= -2 ) {
			double point1[] = { radius * c + (-3), radius * s + (-5.5), 1.5 };
			glTexCoord2d(double(1) / 14 * abs(-6 - point1[0]), double(1) / 16 * abs(-9 - point1[1]));
			glVertex3dv(point1);
		}
	}

	glTexCoord2d(double(1) / 14 * 6, double(1) / 16 * 8);
	glVertex3dv(point4up);

	glTexCoord2d(double(1) / 14 * abs( - 6 - 1), double(1) / 16 * abs(-9 - 2));
	glVertex3d(1, 2, 1.5);
	radius = 4.314591809121557;
	double* p = 0;
	for (int i = 0; i <= number; i++) {
		double c = cos(i * 2 * pi / number);
		double s = sin(i * 2 * pi / number);
		if ((radius * c + 9.227272727272727) <= 8 && radius * s + 2.1363636363636362 <= 5 && radius * s + 2.1363636363636362 >= -2) {
			double point1[] = { radius * c + 9.227272727272727, radius * s + 2.1363636363636362, 1.5 };
			glTexCoord2d(double(1) / 14 * abs(-6 - point1[0]), double(1) / 16 * abs(-9 - point1[1]));
			glVertex3dv(point1);
		}
	}
